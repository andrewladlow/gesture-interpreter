...
public class HandFX extends Group {
    ...
    /**
     * Handles collision of a finger and a button to trigger button presses by
     * physical action.
     * 
    ...
    public void update(Hand hand) {
        ...
        // update positions of other bones (knuckles, index and pinky
        // metacarpals to proximals + metacarpals to metacarpals)
    ...
    /**
     * Updates the position and rotation of a bone between it's two joints.
     * 
