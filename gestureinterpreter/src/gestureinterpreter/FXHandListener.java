...
public class FXHandListener extends Group {
	...
	public FXHandListener (Controller controller, RecorderListener listener, HashMap<Integer, HandFX> hands) {
	...
	public FXHandListener (Controller controller, RecognizerListener listener, HashMap<Integer, HandFX> hands) {
        listener.frameReadyProperty().addListener((frameReady, oldVal, newVal) -> {
    		Frame frame = controller.frame();
